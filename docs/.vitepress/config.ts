...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'QuickLook — Instant File Previews for Windows, Press Space to Preview' }],
    ['meta', { property: 'og:description', content: 'Bring macOS Quick Look to Windows. Press Space to instantly preview images, videos, PDFs, code, and 300+ file formats — no app needed.' }],
